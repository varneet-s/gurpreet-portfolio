...
const projects: ProjectBlogItem[] = [
  {
    ...
    title: 'Guldasta: Bootstrapping a Handcrafted D2C Startup',
    dek: 'Started with my brother Gursimran in January 2026 crafting everlasting bouquets with the help of pipecleaners. Within 5 months: 30+ bespoke bouquets and flower pots sold, ₹20k+ revenue, 56–66% margins, a sell-out at the 20,000-footfall Kala Gali exhibition, and scaling to PAN-India delivery.',
    tools: ['HANDCRAFTED D2C', '56–66% MARGINS', 'PAN-INDIA SHIPPING', 'KALA GALI EXHIBITION'],
    href: '/work/guldasta/',
